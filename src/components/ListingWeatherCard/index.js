...
export const ListingWeatherCard = ({ card }) => {
	...
	const { astronomy, avgtempC, date, maxtempC, mintempC, sunHour, hourly } = card;
			...
			<div className="listing-card__details">
				<div className="listing-card__description">
					<Title level={4} className="listing-card__price">
						...
						<div>{date}</div>
						<Paragraph>avgtempC: {avgtempC} C<sup>0</sup></Paragraph>
					</Title>
					<div className="listing-day-weather-desc">
						<Tag color="success">{desc.value}</Tag>
						<Tag color="warning">maxtempC: {maxtempC} C<sup>0</sup></Tag>
						<Tag color="processing">mintempC: {mintempC} C<sup>0</sup></Tag>
